...
HD_PWD='D:/Nanoprocessor Design Project Files/Nanoprocessor Design Project Files/9. RegisterBank/RegisterBank.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RegisterBank.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RegisterBank.tcl -notrace
